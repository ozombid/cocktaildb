...
import com.example.myapplication3.ui.categories.filter.FilterByCategoryActivity

class CategoriesAdapter(
    private val context: Context,
    private var originalNames: Array<String>,
) : RecyclerView.Adapter<CategoriesAdapter.MyViewClass>() {
    ...
    class MyViewClass(itemView: View) : RecyclerView.ViewHolder(itemView) {
        var txtnom: TextView = itemView.findViewById(R.id.text_listing);
    }
    ...
    override fun onBindViewHolder(holder: MyViewClass, position: Int) {
        ...
        holder.itemView.setOnClickListener {
            val intent = Intent(context, FilterByCategoryActivity::class.java)

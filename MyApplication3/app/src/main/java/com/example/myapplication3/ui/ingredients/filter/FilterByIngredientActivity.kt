package com.example.myapplication3.ui.ingredients.filter
...
class FilterByIngredientActivity : AppCompatActivity() {
    ...
    private lateinit var filter: FilterByIngredientAdapter
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        filter = FilterByIngredientAdapter(this, names, images, ids)
        rv.adapter = filter
    ...
    private fun fetchDataFromApi(category : String) {
        ...
        api.getDetailsByIngredient(category).enqueue(object : Callback<RecipeResponse> {
